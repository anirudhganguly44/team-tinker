    ...
    def training(self, sess, trainers, training_log):
        ...
        for epoch in range(self.configuration.total_epoch):
            ...
            for i in range(self.reader.train_patcher.num_iters_per_epoch):
                ...
                ids_0, images_0, labels_0, hit_ratio_0 =  select_low_loss_samples(ids, images, labels, loss_array_0, selection_ratio, self.reader)
                ids_1, images_1, labels_1, hit_ratio_1 =  select_low_loss_samples(ids, images, labels, loss_array_1, selection_ratio, self.reader)
...
def select_low_loss_samples(ids, images, labels, loss_array, selection_ratio, reader):
